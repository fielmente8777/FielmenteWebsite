...
const ContactForm = () => {
    ...
    return (
        <form
            ...
            className="flex flex-col gap-4 max-md:px-4 p-6 border border-[#110D3C] max-md:mt-6 text-base lg:max-w-[24.875rem] w-full bg-[#F5F5F5]"
        >
            <h2 className="text-xl lg:text-[1.4rem]/[2.5rem] font-normal text-blue-dark">
                Schedule a <span className="text-[#F26633] font-semibold">FREE</span> Demo or Consultation Today!
            </h2>
        ...
        shortly.
            ...
            {formData.map((data, index) => (
                <div key={index} className="flex flex-col gap-1">
                    <div className="flex  gap-2 text-gray-primary p-3 bg-white border-blue-primary ">
                        {/* <label
                            htmlFor={data.name}
            ...
            <button className="w-full text-center bg-orange-primary text-white justify-center border-orange-primary text-md px-8 py-2  font-semibold  hover:bg-white hover:text-orange-primary duration-300 active:scale-75 hover:scale-105 border border-blue-primary">
