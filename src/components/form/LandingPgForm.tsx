  ...
  return (
    ...
    >
              ...
              <div className="flex gap-2 bg-[#1E1E1E] w-full rounded-lg p-3.5">
                ...
                >
                  {countries.map((country, index) => (
                    <option key={index} value={country.code} className="text-primary">
                      {country.code}
                    </option>
                  ))}
                </select>
      ...
      <button
        ...
        className={`w-full text-center text-white justify-center  text-md px-8 py-2 font-semibold rounded-full duration-300 active:scale-75 hover:scale-105  disabled:opacity-50 disabled:cursor-not-allowed ${btnBgColor ? btnBgColor : "bg-tertiary"}`}
      >
