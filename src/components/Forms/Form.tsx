      ...
      content: (
        <div className="flex gap-2 text-base">
          ...
          <input
            ...
            className="w-full bg-transparent rounded-md placeholder:text-white text-white no-spinner focus:outline-none py-2"
          />
        </div>
      ),
    },
    ...
    >
      <div className="col-span-3 grid grid-cols-3 py-2">
        {formData.map((data, index) => (
          <div
            key={index}
            className={`w-full flex flex-col gap-2 items-center ${formData.length - 1 !== index ? "border-r" : ""} border-white/40 "}`}
          >
