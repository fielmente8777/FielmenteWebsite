...
const ProductCard: React.FC<ProductsDataTypes["cards"][0]> = ({
  ...
  return (
    <div className="bg-[#FAFAFA] md:max-w-[307.5px] w-full border border-[#E3E3E3] rounded-2xl md:p-6 p-5 space-y-4 group hover:bg-[#2b59ff] transition-colors duration-300 ease-in-out">
