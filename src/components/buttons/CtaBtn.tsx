...
import { useAppContext } from "@/contextApi/DataContext";
...
export const CtaBtn: React.FC<CtaBtnProps> = ({
  ...
  return type === "button" ? (
    ...
    >
      ...
      {icon === "arrow" && (
        <span
          className={`w-6 aspect-square flex items-center justify-center rounded-full ${iconClass ? iconClass : "text-primary"} ${iconBgClass ? iconBgClass : "bg-white"}`}
        >
          <ArrowBtn />
        </span>
      )}
