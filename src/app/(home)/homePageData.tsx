...
export const homePageData = {
  ...
  faqsData: {
    ...
    cards: [
      {
        question:
          "What services does a Hotel Marketing Company offer?",
        answer:
          "A Hotel Marketing Company offers services like SEO, social media marketing, PPC ads, influencer partnerships, and email campaigns to boost bookings and brand visibility for hotels.",
      },
      {
        question: "Why should I hire a Hotel Marketing Company in India?",
        answer:
          "Hiring a Hotel Marketing Company in India gives you access to local market expertise, cost-effective solutions, and innovative digital strategies tailored to the Indian hospitality industry.",
      },
      {
        question:
          "What industries do you serve apart from being a Hotel Marketing Company in India?",
        answer:
          "In addition to being a trusted Hotel Marketing Company in India, Fielmente also serves restaurants, cafés, resorts, and hospitality groups with tailored marketing strategies.",
      },
    ],
  },
};
