        ...
        <div className="w-[80%]">
          ...
          <div className="mt-14">
            ...
            <ul className="mt-10 flex flex-col gap-4 text-xl text-black">
              {BlogDetails.reviewImportant.list.map((item) => (
                <li>{item}</li>
              ))}
            </ul>
          </div>
          ...
          <div className="mt-14">
            ...
            <ul className="mt-10 flex flex-col gap-10 text-xl text-black">
              {BlogDetails.positiveGoogleReviews.content.map((item) => (
          ...
          <div className="mt-14">
            ...
            <ul className="mt-10 flex flex-col gap-4 text-lg text-black">
              {BlogDetails.stratigies.list.map((item) => (
                <li className="flex flex-col gap-1">{item}</li>
              ))}
            </ul>
          </div>
          ...
          <div className="mt-14">
            ...
            <ul className="mt-10 flex flex-col gap-14 text-lg text-black">
              {BlogDetails.positiveReviews.list.map((item) => (
                <li className="flex flex-col gap-1">
          ...
          <div className="mt-14">
            ...
            <ul className="mt-10 flex flex-col gap-5 text-lg text-black">
              {BlogDetails.negativeFeedBack.subtitle.map((item) => (
                <li className="flex flex-col gap-1">{item}</li>
              ))}
            </ul>

            <ul className="mt-10 flex flex-col gap-14 text-lg text-black">
              {BlogDetails.negativeFeedBack.list.map((item) => (
                <li className="flex flex-col gap-1">
                  <h2 className="font-bold">{item.title}</h2>
