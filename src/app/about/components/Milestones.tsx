...
function Milestones() {
  return (
    <div className="grid lg:grid-cols-3 gap-10">
      <div>
        <h2 className="text-6xl font-normal text-black text-center">120</h2>
        <h3 className="text-lg text-black text-center">COMPLETED PROJECTS</h3>
      </div>
      <div>
        <h2 className="text-6xl font-normal text-black text-center">95%</h2>
        <h3 className="text-lg text-black text-center">SATISFACTION RATE</h3>
      </div>
      <div>
        <h2 className="text-6xl font-normal text-black text-center">8+</h2>
