...
function Agency() {
  return (
    <section>
      <h2 className="text-center lg:text-3xl text-2xl text-black font-semibold">
        KNOW MORE ABOUT US
      </h2>
      <div className="grid lg:grid-cols-5 sm:gap-16 gap-4 items-center mt-10">
        ...
        <div className="flex flex-col sm:gap-10 gap-6 lg:col-span-3">
          <p className="text-black lg:text-lg/[2rem] text-base text-justify">
