...
export const ServiceCard: React.FC<ServicesSectionProps["services"][0]> = ({
  ...
  return (
    <div className="bg-white rounded-2xl shadow-blur p-2 border border-main-border group hover:border-color4 ease-in-out duration-300 transition-all flex flex-col gap-3">
      <div className="w-full relative md:aspect-[4/2] aspect-[4/2.25] rounded-2xl group-hover:shadow-md overflow-hidden">
        <Image
          src={src}
          alt={title}
          fill
