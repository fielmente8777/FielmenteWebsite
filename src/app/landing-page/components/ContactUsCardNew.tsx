        ...
        <div className="grid md:grid-cols-2 gap-8 items-center py-10">
          ...
          <div className="lg:text-start text-center flex flex-col max-md:items-center gap-4">
            ...
            <button
              ...
              className="bg-orange-primary w-fit px-6 py-3 flex items-center justify-center font-bold rounded-md text-lg border border-orange-primary hover:bg-transparent duration-300"
            >
