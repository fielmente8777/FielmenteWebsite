    ...
    <div className="grid lg:grid-cols-5 items-center gap-8">
      ...
      <div className="lg:col-span-3 flex flex-col sm:gap-10 gap-5">
        <div>
          ...
          <p className="sm:text-xl text-lg text-gray-primary mt-2 lg:text-start text-center">
            Are you doing everything you can to make sure:
          </p>
        </div>
        <ul className="list-disc list-inside lg:text-start text-center text-gray-primary sm:text-xl text-lg">
